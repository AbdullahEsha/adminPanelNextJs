...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Swop Admin - Dashboard</title>
                    ...
                    <div className="sales-data-body">
                      ...
                      <div className="amount-col">
                        <div style={{ backgroundColor: "#CDE7FF" }}>
                          <div
                            style={{ backgroundColor: "#0095FF", width: "70%" }}
                          />
                        </div>
                      </div>
                    ...
                    <div className="sales-data-body">
                      ...
                      <div className="amount-col">
                        <div style={{ backgroundColor: "#8CFAC7" }}>
                          <div
                            style={{ backgroundColor: "#00E096", width: "70%" }}
                          />
                        </div>
                      </div>
                      <p className="owed-col">
                    ...
                    <div className="sales-data-body">
                      ...
                      <div className="amount-col">
                        <div style={{ backgroundColor: "#C5A8FF" }}>
                          <div
                            style={{ backgroundColor: "#884DFF", width: "70%" }}
                          />
                        </div>
                      </div>
                      <p className="owed-col">
                    ...
                    <div className="sales-data-body">
                      ...
                      <div className="amount-col">
                        <div style={{ backgroundColor: "#FFD5A4" }}>
                          <div
                            style={{ backgroundColor: "#FF8F0D", width: "70%" }}
                          />
                        </div>
                      </div>
                      <p className="owed-col">
